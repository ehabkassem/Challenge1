...
print(f"The Total sum of Loans is {sum(loan_costs)}")
...
cal_present_value(new_loan.get("future_value"), new_loan.get("remaining_months"),0.2)
...
for index in range(len(loans)):
    if loans[index]["loan_price"]<500:
        inexpensive_loans.append(loans[index])

# @TODO: Print the `inexpensive_loans` list
print(f"The  inexpensive_loans {inexpensive_loans}")
